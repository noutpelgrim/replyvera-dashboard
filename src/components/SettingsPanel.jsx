...
const SettingsPanel = ({ settings, setSettings, onSave }) => {
  ...
  return (
    <div className="fade-in" style={{ 
      ...
      <div className="glass" style={{ padding: '32px', display: 'flex', flexDirection: 'column', gap: '24px', height: 'fit-content' }}>
        <div>
          <h2 style={{ fontSize: '1.5rem', fontWeight: '800', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <div style={{
          ...
          <div style={{ overflow: 'hidden' }}>
            <div style={{ fontSize: '0.75rem', color: 'hsl(var(--text-muted))', fontWeight: '700', textTransform: 'uppercase' }}>Active Account</div>
            <div style={{ fontSize: '0.9rem', fontWeight: '600', color: 'white', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }}>
        ...
        <form onSubmit={handlePasswordChange} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <label style={{ fontSize: '0.88rem', fontWeight: '600', color: '#E0E0FF' }}>New Password</label>
            <input
              type="password"
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <label style={{ fontSize: '0.88rem', fontWeight: '600', color: '#E0E0FF' }}>Confirm New Password</label>
            <input
              type="password"
